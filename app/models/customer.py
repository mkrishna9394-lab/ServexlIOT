...
class Customer(Base):
    __tablename__='customers'; id=Column(Integer, primary_key=True); name=Column(String(160), unique=True); contact_email=Column(String(160)); is_active=Column(Boolean, default=True); created_at=Column(DateTime, default=datetime.utcnow)
